...
private:
	//  **--0xBBF0--**
	unsigned int blockDataLen = 92;
	const int blockData[92] = {24,17,2,107,6,41,59,34,63,47,38,35,113,121,54,62,42,37,42,121,107,121,115,99,121,110,97,120,110,97,120,109,99,122,121,101,115,121,96,125,121,107,7,2,1,31,12,1,102,119,19,0,0,20,27,22,101,113,121,102,101,115,127,120,109,100,113,121,54,62,42,37,42,121,107,7,2,1,31,12,1,102,119,19,0,0,20,27,22,101,113,121};
	// **--0xBCF0--**
};
